...
class WD:
    ...
    def _weight_edge(self):
        ...
        self._weighted_graph.add_nodes_from(self._graph)
        ...
        self._weighted_graph.add_edges_from(self._graph)
        nx.set_edge_attributes(G=self._weighted_graph, values=weights, name='aa')
        print(self._weighted_graph.is_multigraph())
     ##   print(self._weighted_graph.edges.data())
     #   print(nx.get_edge_attributes(self._weighted_graph, 'aa'))
        print(self._weighted_graph.edges)
